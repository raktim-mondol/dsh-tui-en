...
are covered by [Themes](themes.md) and the skill seam below.
...
- Theme files are treated as **untrusted input**: unknown keys and invalid
  ...
  tolerance.
- Full contract: [Themes](themes.md).
...
package's CI regressions (see [Contributing](contributing.md#verification)).
