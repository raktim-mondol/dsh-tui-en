...
stdin.write('\r')
await settle(() => screenText().includes('Current session color'))
...
stdin.write('\r')
await settle(() => screenText().includes('Unknown color'))
check('未知色名报错且不写状态', channel.notifications.some(n => n.includes('Unknown color')) && channel.sessionColor === 'red')
